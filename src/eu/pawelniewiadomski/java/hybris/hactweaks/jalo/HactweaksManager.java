...
/**
 * This is the extension manager of the Hactweaks extension.
 */
public class HactweaksManager extends GeneratedHactweaksManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(HactweaksManager.class.getName());
	 ...
	 */
	public static HactweaksManager getInstance()
	{
		return (HactweaksManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				HactweaksConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public HactweaksManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of HactweaksManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of HactweaksManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of HactweaksManager called, current tenant: " + getTenant().getTenantID());
		}
	}
